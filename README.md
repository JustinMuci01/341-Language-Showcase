...
print_files.sh - This script will print the contents of all files within the TEST_FILES folder.

organize.sh - This script will organize the text and c files into respective folders within the TEST_FILES folder.

Video Presentation : https://www.youtube.com/watch?v=mZoFohpfkk0&feature=youtu.be 
The slides folder will have a pdf of the slides I used during the video presentation.
